...
numhid = 3
chains = [[Lux.Chain(Dense(1, numhid, tanh), Dense(numhid, numhid, tanh), Dense(numhid, 1)) for i in 1:2];
                        [Lux.Chain(Dense(2, numhid, tanh), Dense(numhid, numhid, tanh), Dense(numhid, 1)) for i in 1:2]]
